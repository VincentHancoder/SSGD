...
label_ids = {
    ...
    "starfish": 4,
    "waterweeds": 5
} # TODO: get label_ids automatically
...
def main():
    xml_path = '/home/yr2/project/mmdetection_underwater/data/data_optics/train/box'
    img_path = '/home/yr2/project/mmdetection_underwater/data/data_optics/train/image'
    save_path = '/home/yr2/project/mmdetection_underwater/data/data_optics/annotations/all.json'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, save_path)
    print('Done!')
